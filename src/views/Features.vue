...
const features = [
    {
        ...
        description: "Battle against others to conquer the first place on the monthly leaderboard!",
    },
    {
        title: "The Profile",
        description: "Make your profile pretty and show off your stats to your rivals!",
    },
    {
        title: "The Stats",
        description: "Analyze everyone's stats and adjust your poop tactics to keep up with competition!",
    },
    {
        title: "The Cards",
